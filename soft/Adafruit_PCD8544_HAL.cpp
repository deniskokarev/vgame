...
Adafruit_PCD8544_HAL::Adafruit_PCD8544_HAL(SPI_HandleTypeDef &hspi,
										   ...
										   ):Adafruit_GFX(LCDWIDTH, LCDHEIGHT),_hspi(hspi),_dc(dc),_cs(cs),_rst(rst) {
}
...
inline void Adafruit_PCD8544_HAL::spiWrite(uint8_t d) {
    // Hardware SPI write.
	HAL_SPI_Transmit(&_hspi, &d, 1, 0);
...
void Adafruit_PCD8544_HAL::data(uint8_t c) {
