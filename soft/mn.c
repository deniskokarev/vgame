...
#else
	HAL_SPI_Transmit(GLCD_DEVICE_SPI, &data, 1, 0);
	while(HAL_SPI_GetState(GLCD_DEVICE_SPI) !=  HAL_SPI_STATE_READY) {
	}
#endif
...
void lcdFunTime()
{
  ...
  for (int i=0; i<pixelCount; i++)
  {
    ...
    // white.
    setPixelb(random(0, LCD_WIDTH), random(0, LCD_HEIGHT));
